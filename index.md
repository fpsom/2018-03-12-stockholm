...
venue: "KTH Royal Institute of Technology"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Room Fantum, Lindstedtsvägen 24, F-building, 5:th floor, KTH Campus, 114 28 Stockholm"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "59.348333,18.074765"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use http://www.latlong.net/)
...
instructor: ["Fotis E. Psomopoulos", "Thor Wikfeldt"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Olav Vahtras", "Cathrine Bergh", "Tony Lundgren"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["kthw@kth.se"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: http://pad.software-carpentry.org/2018-03-12-stockholm     # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: 42260122163          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
